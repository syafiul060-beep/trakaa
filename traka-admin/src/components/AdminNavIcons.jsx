/**
 * Ikon sidebar admin (SVG) — hindari emoji untuk aksesibilitas & konsistensi tema.
 */
...
export function NavIconDashboard({ className }) {
  return (
...
export function NavIconOrders({ className }) {
  return (
    <svg {...svgProps(className)}>
...
export function NavIconDrivers({ className }) {
  return (
    <svg {...svgProps(className)}>
...
export function NavIconChat({ className }) {
  return (
    <svg {...svgProps(className)}>
...
export function NavIconReports({ className }) {
  return (
    <svg {...svgProps(className)}>
...
export function NavIconViolations({ className }) {
  return (
    <svg {...svgProps(className)}>
...
export function NavIconAudit({ className }) {
  return (
    <svg {...svgProps(className)}>
...
export function NavIconNotifications({ className }) {
  return (
    <svg {...svgProps(className)}>
...
export function NavIconBroadcast({ className }) {
  return (
    <svg {...svgProps(className)}>
...
export function NavIconChevronLeft({ className }) {
  return (
    <svg {...svgProps(className)}>
...
export function NavIconChevronRight({ className }) {
  return (
    <svg {...svgProps(className)}>
...
const ICON_MAP = {
  ...
  drivers: NavIconDrivers,
  chat: NavIconChat,
  reports: NavIconReports,
  violations: NavIconViolations,
  audit: NavIconAudit,
